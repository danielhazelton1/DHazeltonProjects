# -*- coding: utf-8 -*-
"""
Created on Thu May  6 18:20:59 2021
...
if __name__ == "__main__":
   ...
   file = pd.read_csv('admetest.data')
   data = file.to_numpy()
   d = len(data[0])
   n = len(data)
   random.seed()
   ...
   for trials in range(num_trials):
      ...
      for i in range(1, 1000, 50):
         test_set = sample(list(examples),100)
         train_set = sample(list(examples), i)
